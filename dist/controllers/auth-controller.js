...
class AuthController {
    static async userRegister(req, res) {
        ...
        const existingUser = await user_model_1.default.findOne({ where: { userEmail } });
        if (existingUser) {
            res.status(400).json({
    ...
    static async userLogin(req, res) {
        ...
        //checking password
        const isPasswordMatching = bcrypt_1.default.compareSync(userPassword, existingUser.userPassword);
    ...
    static async forgotPassword(req, res) {
        ...
        const OTP = (0, generateOTP_1.sendOPT)();
